...
def fq2fa(raw_file, out_file):
    ...
    '''
    #raw_file='/home/liliandong/workspace/pyKraken/sampled_genomes/db_750.fastq'
    #out_file='/home/liliandong/workspace/pyKraken/sampled_genomes/db_750.fa'
    file_type='fastq'
    min_trim=0
    max_trim=0
    ori_seq_len=150
