...
class VariantLocator:
    ...
    def output_iSNV_area(self, high_frequency_kmer_dict, connection_mat, \
                        unique_long_kmers, long_kmer_counts, reads_abun, \
                        ref_kmer_builder):
                ...
                if end_idx:
                    ...
                    for kmer in temp_area_kmer:
                        if kmer == temp_area_kmer[0]:
                            ...
                            var_seq='{}{}'.format(var_seq, decode(kmer, kmer_length, \
                                                                  return_base = False)[-1])
...
def output_iSNV_area_bk(seq, high_frequency_kmer_dict, ref_kmer_dict, ref_kmer_f_dict, \
            ...
            if end_idx:
                ...
                for kmer in temp_area_kmer:
                    if kmer == temp_area_kmer[0]:
                        ...
                        var_seq='{}{}'.format(var_seq, decode(kmer, kmer_length, return_base = False)[-1])
